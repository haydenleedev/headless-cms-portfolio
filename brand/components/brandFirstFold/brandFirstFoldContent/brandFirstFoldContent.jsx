...
import style from "./brandFirstFoldContent.module.scss";
const BrandFirstFoldContent = ({fields, sanitizedHtml}) => {
        ...
        <AgilityLink
          ...
          className={`
            ${
              ...
              ${
                primary
                  ? `cyan outlined ${style.primaryLink}`
                  : style.secondaryLink
              }`
                : ""
        ...
        {fields.media && !fields.customSVG && !fields.imageLink && (
          <div
            className={`${style.image} ${style.brandimage} ${
              fields.circularImage ? style.circularImage : style.removeCircular
...
export default BrandFirstFoldContent;