...
class ContactForm extends Component {
  ...
  handleSubmit() {
    ...
    // Validating
    if (this.onSubmitValidate() && this.form.permission.checked) {
              ...
              <div
                className={`${layout.col} ${layout["col-2"]} ${
                  this.state.errors.companyName
                    ? form.error
                    : this.state.touched.companyName
                    ? form.valid
                    : null
                }`}
              >
            ...
            >
              ...
              >
                ...
                <span className={form.check}>
                  ...
                  <a
                    href="https://ujet.cx/privacy-notice/"
                    className={`${layout.link} ${layout.bold} ${form["mlr-5px"]}`}
                    target="_blank"
                    rel="noreferrer"
                  ...
                  and
                  <a
                    href="https://ujet.cx/terms-of-service/"
