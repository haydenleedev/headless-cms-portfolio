  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination:
          "/press-releases/built-in-honors-ujet-in-2022-best-places-to-work-awards",
        permanent: true,
      },
      {
      ...
      {
        source:
          "/blog/10-chat-support-job-responsibilities-what-you-need-to-know-about-providing-live-chat-support-t",
